/**
 * This code draws the polyheadra on the canvas.
 * This code is not very readable as just of it was written programmatically.
 */
...
function updatesFace() {
    // Sometimes we generate an icsahedron, sometimes a dodecahedron, and sometimes both
    if (shapeType == "ico") {
        faces = [
            [b[0], g[0], b[4]],
            [b[1], h[2], b[2]],
...
function randomizeShape() {
    shapeType = selectAtRandom(["ico", "dodeca", "both"]);
    T_x = 0;
    T_y = 0;
    R = selectAtRandom([0.33 * canvas_edge, scale * canvas_edge, scale * canvas_edge]);
    R0 = selectAtRandom([40, 100, 166, 225]);

    noStellation = selectAtRandom(Array(20).fill(0).concat([1]));
    stellation = selectAtRandom([[0, 1], [1, 0], [1, 1]]);
    speedR = selectAtRandom([2000, 2000, 3000, 4000, 8000]);
    speedR0 = selectAtRandom([1000, 1500, 4000, 5000, 6000]);

    plusMinus = selectAtRandom([-1, 1]);
    plusMinus2 = selectAtRandom([-1, 1]);
    spin = selectAtRandom([
